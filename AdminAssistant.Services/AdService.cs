...
public class AdService : IAdService
{
        ...
        return await Task.Run(() =>
        {
            ...
            var query = searcher.FindAll()
                ...
                .Select(g => new AdGroupResult
                {
                    ...
                    DistinguishedName = ResolveGroupDistinguishedName(g),
    ...
    private static string ResolveGroupDistinguishedName(GroupPrincipal group)
    {
        ...
        return Get(entry!, "distinguishedName");
    }
